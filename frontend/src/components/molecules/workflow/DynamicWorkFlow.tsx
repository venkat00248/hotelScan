...
const DynamicWorkFlow = () => {
  ...
  const handleFormSubmit = async (formValues: any) => {
    ...
    try {
      const res = await WorkFlowService.addAction({
  ...
  useEffect(() => {
    const updateNodeName = async () => {
      if (nodeName !== "") {
        ...
        try {
          const res = await WorkFlowService.updateTask({
            taskId: selectedTaskId,
            workFlowId: workFlowID,
            taskData: {
              name: nodeName,
  ...
  const deleteNode = async () => {
    ...
    try {
      const res = await WorkFlowService.deleteTask({
        taskId: selectedTaskId,
        workFlowId: workFlowID,
      });
      // console.log("res", res);
            ...
            <div className="popup">
              ...
              >
                <TextField
                  ...
                  variant="outlined"
                  value={edgeLabel}
                  onChange={(evt) => setEdgeLabel(evt.target.value)}
                />
