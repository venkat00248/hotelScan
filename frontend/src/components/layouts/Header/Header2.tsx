      ...
      <header>
        <div id="page-topbar">
          <div className="navbar-header">
            <div className="d-flex align-items-center w-100 d-flexmbl">
              ...
              {<h2 className="text-white tthreetext text-uppercase headertitle" id="tthreetextMobile">
              Work Flow Method
              </h2>}
      ...
      <div className="modal right fade" id="settingModal">
        <div className="modal-dialog">
          <div className="modal-content rounded-0">
            ...
            <div className="modal-body p-0 rightsidemenu">
              <div className="scrollable-container">
