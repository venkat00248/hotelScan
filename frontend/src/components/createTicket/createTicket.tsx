...
export const CreateTicket = () => {
    ...
    const [typeOption, setTypeOption]: any = useState(null);
        ...
        if(result == undefined) {
            ...
            if (ticketType.length == 0) {
                try {
                    ...
                    const res = await TicketTypeService.getTicketType()
        ...
        if (ErrorObj?.length === 0) {
            ...
            setIsLoading(true);
                        ...
                        try {
                            ...
                            const response = await TicketTypeService.createTicket({name:subject,description:description,priority:priority,tickettypeid:tickettypeid , serverInfo:subject});
                            const mappedWorkflow = await TicketTypeService.getMappedWorkflow()
    ...
    const fetchData = async () => {
        ...
        if(result == undefined) {
            try {
                const res = await TicketTypeService.getCustomerList();
